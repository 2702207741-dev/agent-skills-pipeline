...
| Codex maintenance use | [`codex-maintenance`](../eval-runs/codex-maintenance/) contains 12 Git-pinned review, triage, release, and security records. |
...
| External interface | [`action.yml`](../action.yml) runs against a clean consumer fixture and rejects tampering and traversal. |
| Recoverable writes | Marketplace install and update are dry-run-first, audited, backed up, and rollback-tested. |
...
- Registry federation and transactional dependency resolution remain roadmap work.
