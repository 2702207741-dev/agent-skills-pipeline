...
| Rollback failure or audit deletion | Backups, mandatory rollback flow, strict doctor checks, and append-style audit records | Disk loss or deliberate deletion can remove local history. Retain external release evidence and backups for critical use. |
