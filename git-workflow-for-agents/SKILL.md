...
| 用户说"创建 PR""提 pull request" | 解决 merge conflict（属于调试，用 debugging skill） |
...
| **code-review-and-quality** | PR 前用 code-review 的五轴审查，然后走本 skill 的 PR 前自检；review 意见按 commit 拆分 |
